...
public class EmployeeJsonDAO extends ModuleJsonDAO<Employee> {
    ...
    private static EmployeeJsonDAO instance;
    ...
    public static EmployeeJsonDAO getInstance() {
        if(instance == null){
            instance = new EmployeeJsonDAO();
            return instance;
        }
