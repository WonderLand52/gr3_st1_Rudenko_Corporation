...
public class DeptJsonDAO extends ModuleJsonDAO<Department> {
    ...
    private static DeptJsonDAO instance;

    private DeptJsonDAO() {
        super(FILE_NAME_JSON_DEPARTMENT, KEY_DEPARTMENT_ID, KEY_DEPARTMENT_NAME);
    }

    public static DeptJsonDAO getInstance() {
        if(instance == null){
            instance = new DeptJsonDAO();
            return instance;
        }
