...
public abstract class BaseIdDAO implements IdDAO {
    ...
    protected BaseIdDAO(String fileName, String keyName, String valuesName) {

        this.keyName = keyName;
        this.valuesName = valuesName;
        System.out.println("Inside BaseIdDAO (fileName: " + fileName + ")");
        try {
